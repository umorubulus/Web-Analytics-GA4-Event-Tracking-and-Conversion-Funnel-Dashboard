...
Implement continuous KPI monitoring using Power BI dashboards to support data-driven decision-making and ongoing website optimization.
---

# ⚙ Installation Guide

Follow the steps below to reproduce this project locally.
...
```bash
git clone https://github.com/umorubulus/Web-Analytics-GA4-Conversion-Funnel-Dashboard.git
```
...
```bash
cd Web-Analytics-GA4-Conversion-Funnel-Dashboard
```
...
```bash
python web_analytics_ga4_funnel_analysis.py
```
...
The Power BI dashboard was built using the processed datasets generated by Python.
...
The dashboard supports interactive business reporting and executive decision-making.
